...
public class MessageReplyLatticeWidget extends Composite {
	...
	MessageMyReplyShortLatticeWidget myshort;
	MessageReplyLatticeWidget mywidget;
	...
	interface ReplyLatticeWidgetWidgetUiBinder extends
			UiBinder<Widget, MessageReplyLatticeWidget> {
	}
	Map<String,List<ReplyListClient>> map;
	public MessageReplyLatticeWidget(MessageMyReplyShortLatticeWidget myshort,String replyParentId, String photo,final String staffName,
