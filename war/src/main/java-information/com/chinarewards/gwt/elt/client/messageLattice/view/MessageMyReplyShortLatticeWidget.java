...
public class MessageMyReplyShortLatticeWidget extends Composite {
	...
	interface MyReplyShortLatticeWidgetWidgetUiBinder extends
			UiBinder<Widget, MessageMyReplyShortLatticeWidget> {
	}

	public MessageMyReplyShortLatticeWidget(final Win win, final DispatchAsync dispatch,
