package com.chinarewards.gwt.elt.client.staffIntegral.dataprovider;
...
public class StaffIntegralAdapter extends BaseDataProvider<StaffWinClient> {
	...
	public StaffIntegralAdapter(DispatchAsync dispatch,
