package com.chinarewards.gwt.elt.client.restaurantList.presenter;
...
import com.chinarewards.gwt.elt.client.restaurantList.dataprovider.RestaurantListViewAdapter;
...
import com.chinarewards.gwt.elt.client.restaurantList.model.RestaurantListCriteria.StaffStatus;
	...
	private void initTableColumns() {
		...
		cellTable.addColumn("员工编号", new TextCell(),
				new GetValue<RestaurantListClient, String>() {
					@Override
					public String getValue(RestaurantListClient staff) {
