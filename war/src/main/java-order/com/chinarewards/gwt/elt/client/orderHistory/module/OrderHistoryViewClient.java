...
public class OrderHistoryViewClient implements Serializable, Comparable<OrderHistoryViewClient> {
 ...
 */
	...
	public OrderHistoryViewClient() {

	}

	public OrderHistoryViewClient(String orderId) {
	...
	@Override
	public int compareTo(OrderHistoryViewClient o) {
