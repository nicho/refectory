 ...
 */
public class SearchAwardShopRequest implements Action<SearchAwardShopResponse> {
	...
	public SearchAwardShopRequest() {
	}

	public SearchAwardShopRequest(GiftCriteria gift,String corporationId,UserRoleVo[] userRoles,String userId) {
		this.gift = gift;
