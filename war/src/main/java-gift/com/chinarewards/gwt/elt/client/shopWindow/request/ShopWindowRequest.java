 ...
 * 
 */
package com.chinarewards.gwt.elt.client.shopWindow.request;
 ...
 */
public class ShopWindowRequest implements Action<ShopWindowResponse> {
	...
	public ShopWindowRequest() {
	}

	public ShopWindowRequest(GiftCriteria gift,String corporationId,UserRoleVo[] userRoles,String userId) {
		this.gift = gift;
