package com.chinarewards.gwt.elt.client.gloryBroadcast.dataprovider;
...
public class GloryBroadcastViewAdapter extends
		BaseDataProvider<StaffHeavenIndexClient> {

	final DispatchAsync dispatch;
	final GloryBroadcastDisplay display;
	StaffHeavenIndexCriteria criteria;
	final ErrorHandler errorHandler;
	final SessionManager sessionManager;
	final Win win;

	public GloryBroadcastViewAdapter(DispatchAsync dispatch,
			StaffHeavenIndexCriteria criteria, ErrorHandler errorHandler,
			SessionManager sessionManager, GloryBroadcastDisplay display,
			Win win) {
