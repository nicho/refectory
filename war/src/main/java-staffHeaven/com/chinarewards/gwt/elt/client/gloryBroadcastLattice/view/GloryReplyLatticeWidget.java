...
public class GloryReplyLatticeWidget extends Composite {
	...
	interface MyReplyLatticeWidgetWidgetUiBinder extends
			UiBinder<Widget, GloryReplyLatticeWidget> {
	}

	public GloryReplyLatticeWidget(final Win win, final DispatchAsync dispatch,
