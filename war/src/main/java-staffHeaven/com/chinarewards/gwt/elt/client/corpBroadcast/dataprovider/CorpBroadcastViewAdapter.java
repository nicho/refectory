package com.chinarewards.gwt.elt.client.corpBroadcast.dataprovider;
...
public class CorpBroadcastViewAdapter extends
		BaseDataProvider<StaffHeavenIndexClient> {

	final DispatchAsync dispatch;
	final CorpBroadcastDisplay display;
	StaffHeavenIndexCriteria criteria;
	final ErrorHandler errorHandler;
	final SessionManager sessionManager;
	final Win win;

	public CorpBroadcastViewAdapter(DispatchAsync dispatch,
			StaffHeavenIndexCriteria criteria, ErrorHandler errorHandler,
			SessionManager sessionManager, CorpBroadcastDisplay display,
			Win win) {
