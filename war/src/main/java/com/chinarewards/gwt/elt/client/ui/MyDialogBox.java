...
public class MyDialogBox extends DecoratedPopupPanel implements HasHTML,
    MouseListener {
  /**
   * Set of characteristic interfaces supported by the {@link MyDialogBox} caption
   * 
  ...
  private class MouseHandler implements MouseDownHandler, MouseUpHandler,
    ...
    public void onMouseOut(MouseOutEvent event) {
      MyDialogBox.this.onMouseLeave(caption);
    }

    public void onMouseOver(MouseOverEvent event) {
      MyDialogBox.this.onMouseEnter(caption);
    }
   ...
   */
  private static final String DEFAULT_STYLENAME = "gwt-DialogBox2";
   ...
   * <ul>
   * <li>-caption = text at the top of the {@link MyDialogBox}.</li>
