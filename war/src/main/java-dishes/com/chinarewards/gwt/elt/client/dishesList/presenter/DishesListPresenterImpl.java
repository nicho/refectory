...
import com.chinarewards.gwt.elt.client.dishesList.dataprovider.DishesListViewAdapter;
...
import com.chinarewards.gwt.elt.client.dishesList.model.DishesListCriteria.StaffStatus;
	...
	private void initTableColumns() {
		...
		cellTable.addColumn("员工编号", new TextCell(),
				new GetValue<DishesListClient, String>() {
					@Override
					public String getValue(DishesListClient staff) {
